...
function PersonalInfo(props) {
    ...
    function getDescription(example) {
        if (example == null) {
            return "";
        }
            ...
            <div className="personal-info__grid">
                <div className="personal-info__photo">
                    <label htmlFor="userphoto">
                        <img src={getPhoto(personal)} alt="avatar" />
                    </label>
                    <input id='userphoto' type="file" onChange={photoChange}
                    accept=".jpg, .png, .jpeg, .gif, .bmp, .tif,"/>
                </div>
                <div className="personal-info__common">
                    <Input type='text' placeholder='First name' name='first-name' value={getFisrtName(personal)} />
                    <Input type='text' placeholder='Last name' name='last-name' value={getLastName(personal)} />
                    <Input classname='personal-info__position' type='text' placeholder='Position' name='job-position' value={getPosition(personal)}/>
                </div>
                <div className="personal-info__contacts">
                    <Input type='text' placeholder='Address' name='address' value={getAddress(personal)} />
                    <Input type='tel' placeholder='Phone number' name='phone' value={getPhone(personal)} />
                    <Input type='email' placeholder='Email' name='email' required='required' value={getEmail(personal)} />
                </div>
                <div className="personal-info__about-me">
                    <textarea name="about-me" placeholder='Tell about yourself' defaultValue={getDescription(personal)}></textarea>
                </div>
            </div>
        </div>
    );
